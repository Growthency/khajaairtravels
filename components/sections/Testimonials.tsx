...
export function Testimonials() {
  ...
  return (
    <section className="section-pad bg-paper-2">
      <Container>
        <SectionHeader
          kicker="Voice of our travellers"
          title={
            <>
              <span className="gradient-text">Real journeys.</span> Real words.
            </>
          }
          subtitle="Every one of these is a real Khaja Air Travels customer. Reach out and we will happily put you in touch with any of them as a reference."
          tone="emerald"
        />
